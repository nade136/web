    ...
    >
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-5">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-xl border border-cyan-400/40 bg-cyan-400/10">
            <Image src="/images/logo1.jpeg" alt="Web3Vault logo" width={24} height={24} className="h-6 w-6 rounded object-cover" />
          </div>
