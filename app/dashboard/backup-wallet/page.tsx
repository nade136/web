      ...
      <div className="rounded-2xl border border-slate-200/70 bg-white p-6 shadow-[0_12px_30px_rgba(15,23,42,0.08)] dark:border-white/10 dark:bg-[#100a1f]/40 dark:shadow-[0_12px_30px_rgba(5,8,20,0.45)]">
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {isLoadingWallets
            ...
            <div
              key={wallet.id}
              className="flex flex-col items-center gap-2 rounded-2xl border border-slate-200/70 bg-slate-50 px-4 py-4 text-center text-slate-700 shadow-[0_10px_24px_rgba(15,23,42,0.08)] transition duration-300 ease-out hover:-translate-y-0.5 hover:shadow-[0_18px_36px_rgba(15,23,42,0.15)] dark:border-white/10 dark:bg-[#1a1130] dark:text-slate-200 dark:shadow-[0_10px_24px_rgba(5,8,20,0.5)] dark:hover:shadow-[0_18px_36px_rgba(5,8,20,0.6)]"
              role="button"
              tabIndex={0}
              onClick={() => {
            ...
            >
              <div
                className={`flex w-12 aspect-square shrink-0 items-center justify-center overflow-hidden rounded-full text-sm font-semibold shadow-[0_8px_16px_rgba(15,23,42,0.12)] dark:shadow-[0_8px_16px_rgba(15,23,42,0.35)] ${
                  wallet.logo_url
                    ? "bg-transparent"
              ...
              <div className="text-xs sm:text-sm font-semibold text-slate-700 dark:text-cyan-300 text-center">
                {wallet.name}
              </div>
            </div>
          ))}
